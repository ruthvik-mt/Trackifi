...
export default function Navbar({ toggleSidebar }: NavbarProps) {
  ...
  return (
    ...
    >
      ...
      {/* Right actions */}
      <div className="gap-4 px-2 py-2 rounded-md text-sm font-medium bg-primary text-primary-foreground hover:bg-primary/90 transition-colors flex items-center justify-center">
        <ThemeToggleButton />
        <button
