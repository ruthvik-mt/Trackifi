...
export default function Sidebar({ isSidebarOpen, setIsSidebarOpen }: SidebarProps) {
  ...
  return (
    <>
      {/* Mobile Topbar */}
      <div className="md:hidden flex items-center justify-between bg-card text-card-foreground p-4 border-b border-transparent shadow-sm transition-none">
      ...
      {/* Sidebar */}
      <aside
        className={`fixed md:relative top-0 left-0 w-64 h-screen transform transition-transform z-40 bg-card text-card-foreground border-r border-transparent md:translate-x-0 transition-none ${
          isSidebarOpen ? "translate-x-0" : "-translate-x-full"
        }`}
      >
        {/* Header */}
        <div className="flex items-center justify-between p-6 border-b border-transparent transition-none">
        ...
        <nav className="flex-1 overflow-y-auto pt-4 text-sm">
          ...
          {/* Divider */}
          <div className="border-t my-5 border-transparent" />
