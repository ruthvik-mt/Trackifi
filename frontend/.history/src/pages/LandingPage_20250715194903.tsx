...
export default function LandingPage() {
  ...
  // Show spinner for 1s on page load
  useEffect(() => {
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      >
        ...
        {buttonLoading ? (
          <button
            disabled
            className="px-6 py-3 rounded-md font-semibold bg-primary text-primary-foreground inline-flex items-center justify-center h-[48px] w-[180px]"
          >
            <Spinner size="default" />
          </button>
        ) : (
