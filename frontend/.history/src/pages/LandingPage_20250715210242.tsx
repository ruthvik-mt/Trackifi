...
>
  ...
  <div className="max-w-4xl mx-auto space-y-6">
    {[
      {
        question: "Is FinShape free to use?",
        answer: "Yes, FinShape is completely free to get started.",
      },
      {
        question: "Can I track multiple accounts?",
        answer: "Absolutely. You can track cash, banks, wallets, and crypto too.",
      },
