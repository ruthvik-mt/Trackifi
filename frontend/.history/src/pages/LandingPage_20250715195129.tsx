...
export default function LandingPage() {
  ...
  // Show spinner briefly on first render (for Start Tracking only)
  useEffect(() => {
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      >
        ...
        {buttonLoading ? (
          <button
            disabled
            className="px-6 py-3 rounded-md font-semibold bg-primary text-primary-foreground inline-flex items-center justify-center transition-colors"
          >
