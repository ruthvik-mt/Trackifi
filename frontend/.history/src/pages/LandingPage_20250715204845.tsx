...
export default function LandingPage() {
  ...
  transition={{ duration: 0.8 }}
>
  <h2 className="text-3xl font-bold mb-6 text-primary">What users are saying</h2>
  <p className="italic text-muted-foreground max-w-2xl mx-auto mb-4">
  ...
  <div className="max-w-4xl mx-auto space-y-6">
    <div>
      ...
      <p className="text-sm text-muted-foreground">
        Yes, FinShape is completely free to get started.
      </p>
    </div>
    <div>
      <h4 className="font-semibold">Can I track multiple accounts?</h4>
      <p className="text-sm text-muted-foreground">
        Absolutely. You can track cash, banks, wallets, and crypto too.
      </p>
    </div>
  </div>
</motion.section>
...
>
  ...
  <div className="max-w-2xl mx-auto">
    ...
    <p className="mb-8 text-lg text-muted-foreground">
      Join FinShape today and start your journey toward smarter money habits.
    </p>
    <Link to="/register">
      <button className="px-6 py-3 text-sm font-semibold bg-primary text-primary-foreground rounded-md hover:bg-primary/90 transition-colors">
        Get Started
      </button>
    </Link>
  </div>
