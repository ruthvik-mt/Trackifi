...
>
  ...
  <div className="max-w-4xl mx-auto space-y-8">
    {[
      " helped me take control of my spending habits. It’s like having a financial coach in my pocket!",
    ...
    {[
      {
        ...
        answer: "Yes,  is completely free to get started.",
      },
      {
...
>
  ...
  >
    ...
    <p className="mb-8 text-lg text-muted-foreground">
      Join  today and start your journey toward smarter money habits.
    </p>
    <div className="flex flex-col sm:flex-row gap-4 justify-center">
      ...
      <footer className="text-center py-6 text-sm text-muted-foreground bg-background">
        © {new Date().getFullYear()} . Built for smarter finance.
      </footer>
    </div>
  );
}
