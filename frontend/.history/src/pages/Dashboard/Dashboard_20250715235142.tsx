      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {[
            ...
            <motion.div
              ...
              className="bg-card rounded-xl p-4 shadow-sm border border-transparent flex items-center gap-4"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <motion.div
            ...
            viewport={{ once: true, amount: 0.2 }}
            transition={{ duration: 1.2, ease: "easeOut" }}
            className="bg-card rounded-lg shadow border border-none p-6 min-h-[200px]"
          >
          ...
          <motion.div
            ...
            viewport={{ once: true, amount: 0.2 }}
            transition={{ duration: 1.2, ease: "easeOut" }}
            className="bg-card rounded-lg shadow border border-transparent p-6 min-h-[200px]"
          >
