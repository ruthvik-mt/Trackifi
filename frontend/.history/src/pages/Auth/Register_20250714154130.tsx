    ...
    <div className="min-h-screen flex justify-center items-center bg-gray-50 px-4">
      ...
      >
        ...
        <input
          ...
          required
          className="w-full border border-gray-300 rounded px-4 py-2 test-gray-800 focus:outline-blue-500"
        />
        ...
        <input
          ...
          required
          className="w-full border border-gray-300 rounded px-4 py-2 focus:outline-blue-500 text-gray-800 placeholder-gray-400"
        />
