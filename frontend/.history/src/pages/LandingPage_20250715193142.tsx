...
export default function LandingPage() {
  ...
  return (
    /* 🔄 1-LINE FIX: drop `transition-colors` on the full‑page wrapper */
  ...
  <button
    onClick={(e) => {
      ...
      setLoading(true);
      setTimeout(() => {
        window.location.href = "/register"; // Simulates loading then redirect
      }, 1000);
    }}
  ...
  >
    {loading ? <LoadingSpinner /> : <>Start Tracking <ArrowRight size={20} /></>}
  </button>
</Link>
