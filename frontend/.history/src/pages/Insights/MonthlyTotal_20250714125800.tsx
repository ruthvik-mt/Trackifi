...
// Helper to convert "YYYY-MM" to "Month YYYY"
        ...
        <Card className="shadow-lg border bg-gradient-to-br from-blue-50 to-white rounded-xl">
          <CardHeader>
            <CardTitle className="text-xl md:text-2xl font-bold text-blue-800">
              Total Spent on {formatMonthYear(month)}
            </CardTitle>
          </CardHeader>
          ...
          <CardContent className="space-y-6">
            <div className="flex items-center gap-3 flex-wrap">
              ...
              <input
                ...
                value={month}
                onChange={(e) => setMonth(e.target.value)}
                className="max-w-xs border border-blue-300 rounded px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-400 bg-white"
              />
            </div>
            ...
            {total !== null && !loading && (
              <div className="h-[320px] w-full pt-2">
                <ResponsiveContainer width="100%" height="100%">
                  <BarChart data={[{ month: formatMonthYear(month), total }]}>
                    <XAxis dataKey="month" />
