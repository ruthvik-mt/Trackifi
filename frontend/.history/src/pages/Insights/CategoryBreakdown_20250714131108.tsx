...
export default function CategoryBreakdown() {
  ...
  return (
    <Layout>
      ...
      >
        <Card className="shadow-lg border bg-gradient-to-br from-indigo-50 to-white rounded-xl">
          <CardHeader>
            <CardTitle className="text-xl md:text-2xl font-bold text-indigo-800">
          ...
          <CardContent className="space-y-6">
            <div className="flex items-center gap-3 flex-wrap">
              ...
              <Input
                ...
                className="max-w-xs border-indigo-300 focus:border-indigo-500"
              />
            </div>
                ...
                <ResponsiveContainer width="100%" height="100%">
                  <PieChart>
                    ...
                    <Tooltip
                      ...
                      contentStyle={{ borderRadius: "8px", borderColor: "#ccc" }}
                    />
                  </PieChart>
                </ResponsiveContainer>
              </div>
