    ...
    <Layout>
      ...
      >
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {/* Summary Card */}
          <Card className="shadow-lg border border-blue-100 bg-blue-50 rounded-xl">
            <CardHeader>
        ...
        {total !== null && total > 0 && (
          ...
          >
            ...
            with your budget under <span className="text-blue-600 font-semibold">Insights → Budget vs Actual</span> for more control.
          </motion.div>
        )}
      </motion.div>
    </Layout>
