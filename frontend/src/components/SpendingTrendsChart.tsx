...
const SpendingTrendsChart = () => {
  ...
  return (
    <div className="space-y-4 px-4 md:px-8 py-6 max-w-6xl mx-auto">
                ...
                <Tooltip
                  content={({ active, payload, label }) => {
                    if (active && payload && payload.length) {
                      return (
                        <div className="bg-white dark:bg-gray-800 text-black dark:text-white border border-gray-300 dark:border-gray-700 p-3 rounded shadow-md text-sm">
                          <p>{label}</p>
